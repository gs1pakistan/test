...
const GeneralForm: React.FC = () => {
  ...
  // Custom city dropdown component - replace your existing city field with this
...
if (!formData.postCode?.trim()) {
  ...
  // Frontend handleSubmit function with better error handling
  // Direct call alternative - API route bypass
  // .env.local mein NEXT_PUBLIC_GOOGLE_SCRIPT_URL add karein
