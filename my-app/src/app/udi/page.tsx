...
// NTN validation
  ...
  // Fast optimized handleSubmit function
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    // Prevent input if trying to add 0 after '92'
                    if (value.length === 3 && value.charAt(2) === '0') {
                      return; // Don't update state, ignore the input
                    }
                ...
                {/* Validation Messages */}
                {formData.telephone && formData.telephone.length === 2 && (
                  <p className="error-message" style={{ color: 'red', fontSize: '12px', marginTop: '4px' }}>
                    The first digit after 92 cannot be 0. Please enter digits 1-9.
                  </p>
                )}

                {formData.telephone && formData.telephone.length > 2 && formData.telephone.length < 10 && (
                  <p className="error-message" style={{ color: 'red', fontSize: '12px', marginTop: '4px' }}>
          ...
          <div className="step-content">
            ...
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                {/* Validation Messages */}
                {formData.ceo.telephone && formData.ceo.telephone.length === 2 && (
                  <p className="error-message" style={{ color: 'red', fontSize: '12px', marginTop: '4px' }}>
                    The first digit after 92 cannot be 0. Please enter digits 1-9.
                  </p>
                )}

                {formData.ceo.telephone && formData.ceo.telephone.length > 2 && formData.ceo.telephone.length < 10 && (
                  <p className="error-message" style={{ color: 'red', fontSize: '12px', marginTop: '4px' }}>
                    Please enter at least 8 digits after country code 92.
                  </p>
                )}

                {formData.ceo.telephone && formData.ceo.telephone.length >= 10 && (
                  <p className="successs-message" style={{ color: 'green', fontSize: '12px', marginTop: '4px' }}>
                    ✓ Valid Number format
                  </p>
                )}
          ...
          <div className="step-content">
            ...
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                {/* Validation Messages */}
                {formData.keyContact.telephone && formData.keyContact.telephone.length === 2 && (
                  <p className="error-message" style={{ color: 'red', fontSize: '12px', marginTop: '4px' }}>
                    The first digit after 92 cannot be 0. Please enter digits 1-9.
                  </p>
                )}

                {formData.keyContact.telephone && formData.keyContact.telephone.length > 2 && formData.keyContact.telephone.length < 10 && (
                  <p className="error-message" style={{ color: 'red', fontSize: '12px', marginTop: '4px' }}>
                    Please enter at least 8 digits after country code 92.
                  </p>
                )}

                {formData.keyContact.telephone && formData.keyContact.telephone.length >= 10 && (
                  <p className="successs-message" style={{ color: 'green', fontSize: '12px', marginTop: '4px' }}>
                    ✓ Valid Number format
                  </p>
                )}
          ...
          <div className="step-content">
            ...
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                {/* Validation Messages */}
                {formData.accountsContact.telephone && formData.accountsContact.telephone.length === 2 && (
                  <p className="error-message" style={{ color: 'red', fontSize: '12px', marginTop: '4px' }}>
                    The first digit after 92 cannot be 0. Please enter digits 1-9.
                  </p>
                )}

                {formData.accountsContact.telephone && formData.accountsContact.telephone.length > 2 && formData.accountsContact.telephone.length < 10 && (
                  <p className="error-message" style={{ color: 'red', fontSize: '12px', marginTop: '4px' }}>
                    Please enter at least 8 digits after country code 92.
                  </p>
                )}

                {formData.accountsContact.telephone && formData.accountsContact.telephone.length >= 10 && (
                  <p className="successs-message" style={{ color: 'green', fontSize: '12px', marginTop: '4px' }}>
                    ✓ Valid Number format
                  </p>
                )}
        ...
        return (
          <div className="step-content">
            ...
            <div className="fee-structure">
              ...
              <p className='fee-description'> (RENEWAL FEE IS DUE UPON COMPLETION OF THREE YEARS FROM THE DATE OF LICENSE ALLOCATION)</p>
              <p className='fee-description'>As of from the fourth year, companies are requested to pay the three years renewal fee. For example, if you
                request 300 GTIN-14s, you will need to pay Rs. 161,731/- (covering three years license fee).</p>
              <p className='fee-description'> Note: Late fee charges of 5% will apply to the renewal invoice if payment is made after the due date.</p>
            </div>
          </div>
        );
          ...
          <div className="step-content">
            ...
            <div className="terms-conditions">
              ...
              <div className="terms-content">
                ...
                <div className="term-item">
                  <strong>17. Membership Agreement and License:</strong> Membership Agreement and License is governed
                  by the law GS1 GTIN 14s used for unique
                  identification of medical devices (“Unique Device
                  Identifiers” or “UDI”).
                  Member Company understands that GS1 Pakistan is
                  a member of the global GS1 organization (“GS1
                  Global Office”), which has been accredited by
                  certain regulatory agencies as an issuer of UDIs
                  and, in that capacity, both are subject to certain
                  regulatory obligations (e.g. reporting of companies
                  that use the GS1 standards for unique identification
                  of medical devices).
                  Member Company understands that when it uses
                  GS1 GTIN 14s to identify a product that may be
                  characterize as a medical device under the laws of
                  the country where such product is marketed (a
                  “Medical Device”), the following rules shall apply:
                  Upon applying for a license Member Company
                  must inform GS1 Pakistan if a GS1 GTIN 14s will be
                  used to identify a Medical Device and in which
                  country the related product will be marketed;
                  Member Company is and shall at all times remain
                  responsible for the information about the Medical
                  Device provided by it to GS1 Pakistan and for
                  compliance with any applicable regulatory
                  obligations and shall ensure any information
                  provided to MO is accurate and up to date at all
                  times.
                  GS1 Pakistan may monitor correct implementation
                  of the GS1 Standards by Member Company;
                  In case GS1 Pakistan identifies a Deficiency (as
                  defined in section c below), GS1 Pakistan may
                  inform Member Company in writing (addressed to
                  Member Company usual contact person) of such
                  Deficiency, suggesting a way to correct the
                  Deficiency and requiring Member Company to
                  correct such Deficiency within 90 calendar days
                  from the date of the notification (the “Correction
                  Period”).
                  GS1 Pakistan may monitor whether Member
                  Company has corrected a Deficiency within the
                  Correction Period. Failing such correction, at the
                  latest eight (8) calendar days after expiry of the
                  Correction Period, GS1 Pakistan may contact
                  Member Company again and seek to amicably
                  resolve the Deficiency.
                  If the Deficiency is not corrected within an
                  additional period of 90 days from the expiry of the
                  Correction Period and pertains to a repeated
                  and/or deliberate misuse of the GS1 Standards
                  related to UDI, GS1 Global Office, working with the
                  GS1 MO, may inform the regulator and modify the
                  use (incl. suspension and revocation) of the GS1
                  Company Prefix for UDI implementation in the
                  relevant jurisdiction, as a follow-up action taken in
                  cooperation with the relevant regulator.
                  Member Company acknowledges and agrees that
                  GS1 Pakistan must, in the context of its regulatory
                  obligations, share certain information with the
                  relevant regulators either directly or via GS1 Global
                  Office, including without limitation: the fact that
                  Member Company uses the GS1 GTIN 14s to identify
                  Medical Devices marketed in the regulators
                  country, the GS1 GTIN 14s, the name of Member
                  company, as well as any identified and uncorrected
                  Deficiencies. Member Company understands that
                  neither GS1 Pakistan nor GS1 Global Office may be
                  held liable for any direct or indirect consequences,
                  losses or damages resulting of GS1 Pakistan and/or
                  GS1 Global Office providing such information to a
                  regulator.
                  For the purpose of this section, a “Deficiency”
                  means any of the following: a misconstruction of
                  the identifier, a mismatch between the name of the
                  company holding the license for the GS1 Key and
                  the company using the GS1 Key or any other
